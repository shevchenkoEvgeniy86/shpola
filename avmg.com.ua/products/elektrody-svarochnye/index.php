...
$APPLICATION->SetTitle("Електроди зварювальні");
$APPLICATION->SetPageProperty("title",       "Електроди ► купити зварювальні електроди в Україні: Дніпро, Київ, Харків, Львів, Одеса, опт, роздріб | Напрямок АВ метал груп ™ avmg.com.ua");
$APPLICATION->SetPageProperty("description", "Зварювальні електроди асортимент і ціни ▻ АВ метал груп ™ ✓Шірокій вибір ✓Металлобази і доставка по всій Україні ☎ (056) 790-01-22");
