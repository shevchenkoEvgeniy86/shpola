...
$APPLICATION->SetTitle("Оцинкованный металлопрокат");
$APPLICATION->SetPageProperty("title",       "Сталь оцинкованная в рулонах цена ► купить рулон оцинкованный в Украине: Днепр, Киев, Харьков, Львов, Одесса, опт, розница | Направление АВ металл групп ™ ru.avmg.com.ua");
$APPLICATION->SetPageProperty("description", "Оцинкованная сталь ассортимент и цены ▻ АВ металл групп ™ ✓Широкий выбор ✓Металлобазы и доставка по всей Украине ☎ (056)790-01-22");
...
$APPLICATION->IncludeComponent
	...
	"bitrix:news", "av",
		...
		"SEF_MODE"          => "Y",
		"SEF_FOLDER"        => "/products/galvanized-metal/",
