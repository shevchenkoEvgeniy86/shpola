...
$APPLICATION->SetTitle("Черный металлопрокат");
$APPLICATION->SetPageProperty("title",       "Черный металл ► купить черный металлопрокат в Украине: Днепр, Киев, Харьков, Львов, Одесса, опт, розница, цены на металл, прайс металолопрокат | Направление АВ металл групп ™ ru.avmg.com.ua");
$APPLICATION->SetPageProperty("description", "Черный металл ассортимент и цены ▻ АВ металл групп ™ ✓Широкий выбор ✓Металлобазы и доставка по всей Украине ☎ (056)790-01-22");
...
$APPLICATION->IncludeComponent
	...
	"bitrix:news", "av",
		...
		"SEF_MODE"          => "Y",
		"SEF_FOLDER"        => "/products/black-metal/",
